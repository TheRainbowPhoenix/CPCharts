...
// program startup to initialize your default fonts. This way you do not have to
// modify this header fie To do this, we suggest that you change the following
// to modify this header file.s
//
/*--------------------------------------------------------------------------*/
...
public:
  ...
  static PegFont *GetDefaultFont(UCHAR uIndex) { return mDefaultFonts[uIndex]; }
...
private:
  static PegFont
      *mDefaultFonts[PEG_NUMBER_OF_DEFAULT_FONTS + PEG_SPARE_FONT_INDEXES];
};
