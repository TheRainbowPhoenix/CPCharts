...
const WORD DS_STANDARDSTYLE =
    DS_THINNEEDLE | DS_RECTCOR | DS_TICMARKS | DS_CLOCKWISE;
...
enum PegTextSignals {
  PSF_TEXT_SELECT =
      8,         // sent when the user selects all or a portion of a text object
